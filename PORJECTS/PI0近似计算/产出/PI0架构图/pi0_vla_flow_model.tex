...
\draw[flow] (itokens.east) -- (imageTokenOut);
\draw[plainline] (imageTokenOut) |- (concat.north);
...
\draw[repeatbrace] (13.72,3.65) -- (13.72,14.35)
...
\node[greenbox, minimum width=2.65cm, text width=2.32cm] (noisy) at (24.02,14.65)
...
\node[greenbox, minimum width=2.75cm, text width=2.40cm] (timestep) at (21.20,14.65)
  {Flow Timestep $t$};
\draw[flow] (timestep.south east) -- (acttime.north west);
...
\node[callout, minimum width=2.55cm, text width=2.25cm] (coActionMLP) at (28.85,5.92)
