...
\node[font=\sffamily\bfseries\large, align=center, text width=5.3cm] at (16.25,15.38)
  {Pre-trained VLM Backbone\\[-1pt]{\normalsize (PaliGemma-initialized)}};
...
\node[greenbox, minimum width=2.65cm, minimum height=1.46cm, text width=2.32cm] (noisy) at (24.32,14.65)
  {Noisy Action\\Chunk\\[2pt]{\scriptsize $A_t^\tau$}};
...
% Flow matching path
\node[orangebox, minimum width=3.05cm, minimum height=1.28cm, text width=2.75cm] (flowmatch) at (30.95,11.75)
  {Flow Matching\\Sampler /\\Integration};
