...
\draw[flow] ([xshift=0.18cm]rms1.east) -- ++(0.46,0) |- ([xshift=0.04cm]add1.east);
\draw[flow] ([xshift=0.18cm]rms2.east) -- ++(0.46,0) |- ([xshift=0.04cm]add2.east);
\draw[repeatbrace] (14.10,3.65) -- (14.10,14.35)
  node[pos=0.44,left=5pt,font=\sffamily\bfseries\footnotesize] {Nx};
...
\draw[repeatbrace] (24.10,5.45) -- (24.10,12.08)
  node[pos=0.39,left=5pt,font=\sffamily\bfseries\footnotesize] {Nx};
...
\node[callout, minimum width=2.45cm] (coGeluA) at (26.05,4.80) {GELU / SiLU};
